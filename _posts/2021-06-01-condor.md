...
{% capture images %} /assets/img/sky_image.jpeg /assets/psf.jpeg {% endcapture %} {% include gallery images=images caption="A Simulated Image of Stars and the Resulting Modeled PSF" cols=2 %}
